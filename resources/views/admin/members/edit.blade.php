...
<div class="max-w-6xl bg-white border border-slate-100 rounded-xl p-6 shadow-sm">
    ...
    <form method="POST" action="{{ route('admin.members.update', $member->id) }}" class="space-y-5" enctype="multipart/form-data">
        @csrf
        ...
        <div class="pt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.father_member_id_label') }}</label>
