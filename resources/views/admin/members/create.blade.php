...
<div class="max-w-6xl bg-white border border-slate-100 rounded-xl p-6 shadow-sm">
    ...
    <form method="POST" action="{{ route('admin.members.store') }}" class="space-y-5" enctype="multipart/form-data">
        ...
        <div>
            <h3 class="text-xs font-extrabold text-slate-800 uppercase tracking-wider mb-3 pb-1.5 border-b border-slate-100">
                1. {{ __('messages.account_credentials_status') }}
            </h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                <div class="space-y-1 sm:col-span-2">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.email_address_login') }} <span class="text-rose-500">*</span></label>
                    <input type="email" name="email" value="{{ old('email') }}" required placeholder="member@community.com" 
                ...
                <div class="space-y-1 sm:col-span-2">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.status') }} <span class="text-rose-500">*</span></label>
                    <select name="status" required class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                        ...
                        <option value="rejected" {{ old('status') == 'rejected' ? 'selected' : '' }}>{{ __('messages.rejected') }}</option>
                    </select>
                </div>

                <div class="space-y-1 sm:col-span-2">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.security_credentials_sec') }} <span class="text-rose-500">*</span></label>
                    <input type="password" name="password" required placeholder="{{ __('messages.password_min_8') }}" 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>

                <div class="space-y-1 sm:col-span-2">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.confirm_password') }} <span class="text-rose-500">*</span></label>
                    <input type="password" name="password_confirmation" required placeholder="{{ __('messages.repeat_password') }}" 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>
            </div>
        </div>
        ...
        <div class="pt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.first_name_label') }} <span class="text-rose-500">*</span></label>
                    <input type="text" name="first_name" value="{{ old('first_name') }}" required placeholder="Karan" 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>

                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.middle_name_label') }}</label>
                    <input type="text" name="middle_name" value="{{ old('middle_name') }}" placeholder="Father's/Spouse's Name" 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>
                ...
                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.phone_whatsapp_number') }} <span class="text-rose-500">*</span></label>
                ...
                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.gender_label') }} <span class="text-rose-500">*</span></label>
                ...
                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.date_of_birth_label') }} <span class="text-rose-500">*</span></label>
                    <input type="date" name="dob" value="{{ old('dob') }}" required 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>

                <div class="space-y-1 sm:col-span-3">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.profile_photo_label') }}</label>
        ...
        <div class="pt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="space-y-1 sm:col-span-3">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.street_address_label') }} <span class="text-rose-500">*</span></label>
                ...
                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.city_label') }} <span class="text-rose-500">*</span></label>
                    <input type="text" name="city" value="{{ old('city') }}" required placeholder="Ahmedabad" 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>

                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.state_label') }} <span class="text-rose-500">*</span></label>
                    <input type="text" name="state" value="{{ old('state', 'Gujarat') }}" required placeholder="Gujarat" 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>

                <div class="space-y-1">
                    <label class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.pincode_label') }} <span class="text-rose-500">*</span></label>
                    <input type="text" name="pincode" value="{{ old('pincode') }}" required placeholder="380001" 
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>
            </div>
        </div>
