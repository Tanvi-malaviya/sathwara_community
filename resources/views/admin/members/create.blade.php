...
<div class="max-w-6xl bg-white border border-slate-100 rounded-xl p-6 shadow-sm">
    ...
    <form method="POST" action="{{ route('admin.members.store') }}" class="space-y-4" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="space-y-1">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Karan Sathwara" 
                ...
                <div class="space-y-1">
                    <label class="text-[11px] font-bold text-slate-500 uppercase">{{ __('messages.security_credentials_sec') }}</label>
        ...
        <div class="pt-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" placeholder="WhatsApp contact" 
                           maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)"
                           class="w-full text-xs font-semibold px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                </div>
