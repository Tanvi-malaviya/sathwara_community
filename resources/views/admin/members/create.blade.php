            ...
            <form method="POST" action="{{ route('admin.members.store') }}" class="space-y-5" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="space-y-1 sm:col-span-2" x-data="{ showPass: false }">
                            <label
                                class="text-xs font-bold text-slate-500 uppercase">{{ __('messages.security_credentials_sec') }}
                                <span class="text-rose-500">*</span></label>
                            <div class="relative">
                                <input :type="showPass ? 'text' : 'password'" name="password" required placeholder="{{ __('messages.password_min_8') }}"
                                    class="w-full text-xs font-semibold pl-3 pr-9 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500">
                        ...
                        <div class="space-y-1 sm:col-span-2" x-data="{ showConfirmPass: false }">
