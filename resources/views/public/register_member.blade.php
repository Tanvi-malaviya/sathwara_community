    ...
    <div class="max-w-6xl mx-auto px-3 sm:px-4">
        ...
        <div class="bg-white border border-slate-200/80 rounded-lg p-4 md:p-5 shadow-sm">
            ...
            <div class="mb-4 border-b border-slate-100 pb-2 flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-semibold text-slate-800">{{ __('messages.member_registration_form') }}</h2>
                    <p class="text-[10px] text-slate-400 mt-0.5">{{ __('messages.fill_registration_details') }}</p>
                </div>
                <span class="text-[10px] font-bold text-slate-400 bg-slate-100 px-2.5 py-1 rounded-full"><span class="text-rose-500">*</span> {{ __('messages.required_fields') }}</span>
            </div>
            ...
            <form method="POST" action="{{ route('register.member.submit') }}" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    <div class="flex items-center space-x-2 border-b border-slate-100 pb-2 mb-3">
                        ...
                        <h3 class="text-[10px] font-semibold text-slate-700 uppercase tracking-wider">{{ __('messages.personal_details') }}</h3>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.first_name') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.father_middle_name') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.surname_last_name') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.gender') }}</label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.dob') }}</label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.blood_group') }}</label>
                            <select name="blood_group" class="w-full text-xs font-medium px-2 py-1.5 bg-slate-50/50 border border-slate-200 rounded-md focus:bg-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition">
                        ...
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-slate-500 uppercase tracking-wider">{{ __('messages.education') }}</label>
                            <input type="text" name="education" value="{{ old('education') }}" placeholder="{{ __('messages.education_placeholder') }}" class="w-full text-xs font-medium px-3 py-2 bg-slate-50/50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition">
                        </div>
                        <div class="space-y-1">
                            <label class="text-[10px] font-bold text-slate-500 uppercase tracking-wider">{{ __('messages.occupation_details_label') }}</label>
                            <input type="text" name="occupation" value="{{ old('occupation') }}" placeholder="{{ __('messages.occupation_placeholder') }}" class="w-full text-xs font-medium px-3 py-2 bg-slate-50/50 border border-slate-200 rounded-lg focus:bg-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none transition">
                        </div>
                        <div class="space-y-1">
                ...
                <div>
                    <div class="flex items-center space-x-2 border-b border-slate-100 pb-2 mb-3">
                        ...
                        <h3 class="text-[10px] font-semibold text-slate-700 uppercase tracking-wider">{{ __('messages.contact_login_account') }}</h3>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.mobile_whatsapp_number') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div class="space-y-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.member_email_id') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div class="space-y-1 sm:col-span-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.password') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div class="space-y-1 sm:col-span-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.confirm_password') }} <span class="text-rose-500">*</span></label>
                ...
                <div>
                    <div class="flex items-center space-x-2 border-b border-slate-100 pb-2 mb-3">
                        ...
                        <h3 class="text-[10px] font-semibold text-slate-700 uppercase tracking-wider">{{ __('messages.address_details') }}</h3>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                        <div class="space-y-1 sm:col-span-2">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.address') }} <span class="text-rose-500">*</span></label>
                        ...
                        <div class="space-y-1 sm:col-span-1">
                            <label class="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">{{ __('messages.area') }} <span class="text-rose-500">*</span></label>
                ...
                <div class="pt-3 border-t border-slate-100 flex items-center justify-end">
                    <button type="submit" class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-1.5 bg-primary-500 hover:bg-primary-600 font-semibold text-[11px] text-white uppercase tracking-wider rounded-md transition-transform active:scale-95">
                        {{ __('messages.submit_application') }} &rarr;
                    </button>
                </div>
            </form>
        </div>
