<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4" x-data="{ showPass: false }">
            ...
            <div class="relative">
                <input id="password" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-xs block mt-1 w-full pl-3 pr-10 py-2 text-sm"
        ...
        <div class="mt-4" x-data="{ showConfirmPass: false }">
            ...
            <div class="relative">
                <input id="password_confirmation" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-xs block mt-1 w-full pl-3 pr-10 py-2 text-sm"
