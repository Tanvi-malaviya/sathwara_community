...
<head>
    <meta charset="utf-8">
    <title>Business Renewal Receipt - {{ $receiptNo }}</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>બિઝનેસ લિસ્ટિંગ નવીનીકરણ સત્તાવાર રસીદ</p>
            <div class="receipt-badge">Business Renewal Receipt</div>
        </div>
        ...
        <div class="content">
            ...
            <div class="payment-box">
                <table style="width: 100%; font-size: 13px;">
                    <tr>
                        ...
                        <td style="font-weight: 700; text-align: right; color: #0f172a;">Community Business Directory Renewal Fee</td>
                    </tr>
                    <tr>
                        <td style="color: #64748b; padding: 4px 0;">Payment Method</td>
                        <td style="font-weight: 700; text-align: right; color: #0f172a;">Online (Razorpay)</td>
                    </tr>
                    @if(!empty($paymentId))
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <span class="status-pill status-paid">{{ strtoupper($paymentStatus) }}</span>
                        </td>
                    </tr>
                </table>
            ...
            <div class="info-alert">
                ...
                તમારી વ્યવસાય લિસ્ટિંગ સફળતાપૂર્વક એક વર્ષ માટે નવીનીકરણ કરવામાં આવી છે અને હવે ડિરેક્ટરીમાં સક્રિય છે.
            </div>
