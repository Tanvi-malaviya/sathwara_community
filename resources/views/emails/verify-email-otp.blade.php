                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 13px; line-height: 1.6; color: #475569; text-align: center;">
                                We received a request to update your community account email address to <strong>{{ $email }}</strong>. Use the following verification code to proceed. This code is valid for <strong>15 minutes</strong>.
                            </p>
