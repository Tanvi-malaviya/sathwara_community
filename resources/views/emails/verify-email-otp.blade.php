...
<head>
    <meta charset="utf-8">
    <title>Email Update Verification OTP</title>
</head>
                ...
                <table width="570" border="0" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; border: 1px solid #e2e8f0; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 16px 0; font-size: 18px; font-weight: 800; color: #1e293b; text-align: center;">Verify Your New Email Address</h2>
                            <p style="margin: 0 0 24px 0; font-size: 13px; line-height: 1.6; color: #475569; text-align: center;">
                                We received a request to update your community account email address to <strong>{{ $email }}</strong>. Use the following verification code to proceed. This code is valid for <strong>10 minutes</strong>.
                            </p>
                            ...
                            <p style="margin: 32px 0 0 0; font-size: 11px; line-height: 1.6; color: #64748b; text-align: center;">
                                If you did not request this update, you can safely ignore this email. Your email address will remain unchanged.
                            </p>
                        </td>
                    </tr>
