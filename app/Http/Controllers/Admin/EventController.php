...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'total_pass_limit' => 'nullable|integer|min:1',
        ...
        Event::create([
            ...
            'form_start_date' => $hasRegistrationForm ? $request->form_start_date : null,
            'form_end_date' => $hasRegistrationForm ? $request->form_end_date : null,
            'pass_fee' => $request->pass_fee ?? 0.00,
            'total_pass_limit' => $request->total_pass_limit ?: null,
